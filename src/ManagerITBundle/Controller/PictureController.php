...
class PictureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pictures = $em->getRepository('ManagerITBundle:Picture')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('ManagerITBundle\Form\PictureType', $picture);
    ...
    {
        $deleteForm = $this->createDeleteForm($picture);
        $editForm = $this->createForm('ManagerITBundle\Form\PictureType', $picture);

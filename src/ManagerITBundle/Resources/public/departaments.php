                            ...
                            <div class="col-lg-12">
                                <div class="box">
                                    <header>
                                        ...
                                        <h5>Lista działów</h5>
                                        <div class="btn-group">
                                            <a href="#" class="btn btn-primary btn-line btn-rect">Dodaj</a>
                                            <a href="#" class="btn btn-warning btn-line btn-rect">Modyfikuj</a>
                                            <a href="#" class="btn btn-danger btn-line btn-rect">Usuń</a>
                                        </div>
                                    </header>
                                        ...
                                        <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Ilość laptopów</th>
                                                    <th>Ilosć licencji</th>                  
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>

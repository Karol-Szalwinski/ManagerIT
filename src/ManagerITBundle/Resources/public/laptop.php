                                ...
                                <div class="box">
                                    ...
                                    <div id="condensedTable" class="body collapse in">
                                        <table class="table table-condensed responsive-table">
                                            ...
                                            <tbody>
                                                <tr>                                                    
                                                    <td><span class="fa fa-microchip"></span> Procesor</td>
                                                    <td>i5-2500M</td>
                                                </tr>
                                                <tr>
                                                    <td>Ram</td>
                                                    <td>4 GB DDR3 1600</td>
                                                </tr>
                                                <tr>
                                                    <td>GPU</td>
                                                    <td>Zintegrowana</td>
